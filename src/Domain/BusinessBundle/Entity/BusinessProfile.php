    ...
    ChangeStateInterface
{
    ...
    /**
     * @ORM\Column(name="linkedin_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $linkedInURLClicks;

    /**
     * @ORM\Column(name="twitter_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $twitterURLClicks;

    /**
     * @ORM\Column(name="facebook_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $facebookURLClicks;

    /**
     * @ORM\Column(name="google_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $googleURLClicks;

    /**
     * @ORM\Column(name="youtube_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $youtubeURLClicks;

    /**
     * @ORM\Column(name="instagram_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $instagramURLClicks;

    /**
     * @ORM\Column(name="trip_advisor_url_clicks", type="integer", nullable=false, options={"default" = 0})
     */
    protected $tripAdvisorURLClicks;
     ...
     * @return mixed
     */
    public function getLinkedInURLClicks()
    {
        return $this->linkedInURLClicks;
    }

    /**
     * @param mixed $linkedInURLClicks
     */
    public function setLinkedInURLClicks($linkedInURLClicks)
    {
        $this->linkedInURLClicks = $linkedInURLClicks;
    }

    /**
     * @return mixed
     */
    public function getTwitterURLClicks()
    {
        return $this->twitterURLClicks;
    }

    /**
     * @param mixed $twitterURLClicks
     */
    public function setTwitterURLClicks($twitterURLClicks)
    {
        $this->twitterURLClicks = $twitterURLClicks;
    }

    /**
     * @return mixed
     */
    public function getFacebookURLClicks()
    {
        return $this->facebookURLClicks;
    }

    /**
     * @param mixed $facebookURLClicks
     */
    public function setFacebookURLClicks($facebookURLClicks)
    {
        $this->facebookURLClicks = $facebookURLClicks;
    }

    /**
     * @return mixed
     */
    public function getGoogleURLClicks()
    {
        return $this->googleURLClicks;
    }

    /**
     * @param mixed $googleURLClicks
     */
    public function setGoogleURLClicks($googleURLClicks)
    {
        $this->googleURLClicks = $googleURLClicks;
    }

    /**
     * @return mixed
     */
    public function getYoutubeURLClicks()
    {
        return $this->youtubeURLClicks;
    }

    /**
     * @param mixed $youtubeURLClicks
     */
    public function setYoutubeURLClicks($youtubeURLClicks)
    {
        $this->youtubeURLClicks = $youtubeURLClicks;
    }

    /**
     * @return mixed
     */
    public function getInstagramURLClicks()
    {
        return $this->instagramURLClicks;
    }

    /**
     * @param mixed $instagramURLClicks
     */
    public function setInstagramURLClicks($instagramURLClicks)
    {
        $this->instagramURLClicks = $instagramURLClicks;
    }

    /**
     * @return mixed
     */
    public function getTripAdvisorURLClicks()
    {
        return $this->tripAdvisorURLClicks;
    }

    /**
     * @param mixed $tripAdvisorURLClicks
     */
    public function setTripAdvisorURLClicks($tripAdvisorURLClicks)
    {
        $this->tripAdvisorURLClicks = $tripAdvisorURLClicks;
    }
