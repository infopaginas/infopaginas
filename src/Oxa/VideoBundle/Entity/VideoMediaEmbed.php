 ...
 * @ORM\Entity(repositoryClass="Oxa\VideoBundle\Repository\VideoMediaEmbedRepository")
 */
class VideoMediaEmbed
{
    /**
     * @var int
     *
     ...
     * @var VideoMedia
     *
     * @ORM\ManyToOne(targetEntity="VideoMedia", inversedBy="mediaEmbeds")
     * @ORM\JoinColumn(name="video_media_id", referencedColumnName="id")
     */
    private $media;

    public function __construct(array $embedAPIData, VideoMedia $media)
    {
     ...
     * Set media
     *
     * @param \Oxa\VideoBundle\Entity\VideoMedia $media
     *
     * @return VideoMediaEmbed
     */
    public function setMedia(\Oxa\VideoBundle\Entity\VideoMedia $media = null)
    {
        $this->media = $media;
     ...
     * Get media
     *
     * @return \Oxa\VideoBundle\Entity\VideoMedia
     */
