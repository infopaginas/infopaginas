...
define(['jquery', 'iframetracker'], function($, iframeTracker) {
    'use strict';

    var interactionsReport = function() {
        this.listen();
    };

    interactionsReport.prototype.listen = function() {
        //track sections list
        var IMAGE_SECTION_CLASS = '.businessProfileImage';
        var VIDEO_SECTION_CLASS = '.businessProfileVideo iframe';
        ...
        $(VIDEO_SECTION_CLASS).iframeTracker({
            blurCallback: function(){
                var businessProfileId = getBusinessProfileId($(VIDEO_SECTION_CLASS).parent());
